...
class Generator(nn.Module):
    def __init__(self, img_channels, num_features=64, num_residuals=9):
        ...
        self.up_blocks = nn.ModuleList(
            [
                ConvBlock(4*num_features, 2*num_features, down=False, kernel_size=3, stride=2, padding=1, output_padding=1),
                ConvBlock(2*num_features, num_features, down=False, kernel_size=3, stride=2, padding=1, output_padding=1)
            ]
        )
